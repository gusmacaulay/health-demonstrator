Ext.namespace('org.aurin.demonstratortools.health','org.aurin.demonstratortools.health.constants',
'org.aurin.demonstratortools.health.constants.operator','org.aurin.demonstratortools.health.model',
...
window['generateURL']= function(_serviceName){
	//:todo it needs to be configured based on server URL matching bahaviour
	var _url="";
...
org.aurin.demonstratortools.health.prepareUIParameteres= function ( ){	
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox11').getValue();
	if (Ext.getCmp('checkbox11').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo11').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value11').getValue();
	}
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox12').getValue();
	if (Ext.getCmp('checkbox12').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo12').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value12').getValue();
	}
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox13').getValue();
	if (Ext.getCmp('checkbox13').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo13').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value13').getValue();
	}
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox14').getValue();
	if (Ext.getCmp('checkbox14').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo14').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value14').getValue();
	}
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox15').getValue();
	if (Ext.getCmp('checkbox15').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo15').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value15').getValue();
	}
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox21').getValue();
	if (Ext.getCmp('checkbox21').getValue()){
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.OPERATOR]= Ext.getCmp('combo21').getValue();
		_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_VALUE]= Ext.getCmp('slider_value21').getValue();
	}
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox22').getValue();	 
	_UIObject.push(_componentValue);
	//Bulk billing only
	_componentValue={};
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox23').getValue();	 
	_UIObject.push(_componentValue);
	//Fee only
	_componentValue={};
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox24').getValue();	 
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox25').getValue();	 
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox26').getValue();	 
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox27').getValue();	 
	_UIObject.push(_componentValue);
	//Any Sunday service
	_componentValue={};
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox28').getValue();	 
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox29').getValue();	 
	_UIObject.push(_componentValue);
	...
	_componentValue[org.aurin.demonstratortools.health.constants.UIOutputModel.METRIC_INCLUSION]= Ext.getCmp('checkbox30').getValue();	 
	_UIObject.push(_componentValue);
	return _UIObject;
