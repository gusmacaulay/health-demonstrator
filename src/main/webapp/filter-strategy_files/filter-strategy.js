				...
				protocol : new OpenLayers.Protocol.WFS(
						{
							version : "1.1.0",
							srsName : "EPSG:900913",
							url : "http://192.43.209.39:8080/geoserver/wfs",
							// featureNS : "walkability",
							featureType : "melton_roads_sample_projected",
							geometryName : "geom",
							schema : "http://192.43.209.39:8080/geoserver/wfs/DescribeFeatureType?version=1.1.0&typename=shireofmelton:melton_roads_sample_projected"
						})
			});
	//       
...
function init() {
	...
	initWFSTools();
	destinations = new OpenLayers.Layer.WMS("Destinations", "http://192.43.209.39:8080/geoserver/wms", {
		LAYERS : 'shireofmelton:agent_walkability_random_destinations_projected',
		srsName : "EPSG:900913",
		STYLES : '',
		format : 'image/png',
		tiled : true,
